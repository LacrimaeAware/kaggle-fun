...
machine-learning-ready labels for a future learned tick/ruler/bar detector without hand-labeling the
target records?
...
not human annotation and not a submission. Per the Kaggle foundational rule, do not hand-correct
these target masks/boxes and then use them for a submission; keep them fully generated by code.
