...
|------|--------|----|---------| -----------------------------|--------|
| 2026-06-12 | temporal smoothing at clip threshold 0.92 (`submission_burn_04_temporal_smooth_092.csv`) | **0.60961** | PA/FL/MT in 28 sequence-like clips | `results/submission_burn_04_temporal_smooth_092.csv`; follow-ups in `SUBMISSION_BURN_AFTER_TEMPORAL_WIN_2026-06-12.md` | **NEW BEST** |
