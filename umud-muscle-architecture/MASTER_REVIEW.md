...
5. **Free wins available:** apply the OCR scale to IMG_00275 (provably-correct, one image); the verified/text-confirmed scale partition gives confidence the rest are right.
