...
| [UMUD Muscle Architecture](umud-muscle-architecture/) | Image regression (pennation angle, fascicle length, muscle thickness) | UMUD Score (tolerance-normalized MAE) | Active, hard-wall/segmentation retrain | Best public 0.58910; geometry/scale proxies rejected; EXP59 GPU segmentation matrix is next |
...
- [umud-muscle-architecture/](umud-muscle-architecture/): active UMUD Challenge work. Start with [umud-muscle-architecture/docs/CURRENT_STATE_2026-06-13.md](umud-muscle-architecture/docs/CURRENT_STATE_2026-06-13.md), then [umud-muscle-architecture/docs/DOC_INDEX.md](umud-muscle-architecture/docs/DOC_INDEX.md). Holds a gitignored `data/` directory and generated `results/`.
