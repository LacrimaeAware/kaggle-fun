...
| H008 | open | Sampling ISMCTS determinizations from an inferred-archetype belief beats uniform-over-consistent sampling, all else fixed. (Conditional on the forward model.) | medium | A/B self-play where only the belief sampler differs, plus a ladder check. |  | 2026-06-16 |
